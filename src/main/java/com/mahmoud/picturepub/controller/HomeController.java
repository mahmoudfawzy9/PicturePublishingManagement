...
import com.mahmoud.picturepub.service.SecurityService;
import com.mahmoud.picturepub.service.UserService;
import com.mahmoud.picturepub.utils.UserMapper;
...
public class HomeController {
    ...
    @Autowired
    public HomeController(SecurityService securityService, PictureService picService, UserMapper userMapper) {
    ...
    public String loginSuccessful(HttpServletRequest request, Model model) {
        List<Picture> list = picService.getAllByStatus(List.of(Status.ACCEPTED));
